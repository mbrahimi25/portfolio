...
>
					...
					<div className="flex gap-12">
						{/* Links */}
						{ (link || github || gitlab || pypi || arcgis || linkedin) && (
						<div className="mt-8 gap-4">
						<p className="mt-4 text-sm uppercase tracking-[0.3em] text-white/50">Links</p>
						...
						<div className="mt-8 gap-4">
							{children && (
								<>
									<p className="mt-4 text-sm uppercase tracking-[0.3em] text-white/50">Tech Stack</p>
				...
				<p className="mt-4 max-w-3xl text-lg leading-8 text-white/70">{desc}</p>
